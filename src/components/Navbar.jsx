  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1152, margin: '0 auto', padding: '0 24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 68 }}>
          ...
          <button
            ...
            style={{ border: 'none', background: 'none', color: '#FF6B00', cursor: 'pointer' }}
          >
      ...
      {menuOpen && (
        <div
          className="md:hidden"
          style={{ background: 'rgba(8,8,8,0.98)', borderTop: '1px solid #161616', padding: '16px 24px 24px' }}
        >
